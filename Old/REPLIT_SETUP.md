...
2.  **Upload the ZIP**:
    *   In the Replit sidebar (Files), click the three dots (`...`) and select **Upload file**.
    *   Select `MineBot_Replit.zip` from your computer.

3.  **Unzip the Files**:
    *   Open the Replit **Shell** (tab next to Console) and type:
        ```bash
        unzip MineBot_Replit.zip
        ```
